...
.WaitSPC700    
    CMP.w PPURegisters.APUPort0Reg2140  ;|
    BNE .WaitSPC700  
    SEP #$20                            ;Make A 8-bit
    ...
    INY                                 ;/
Entry2:    
    STA.w PPURegisters.APUPort2Reg2142  ;Store the address to APU I/O ports 2 and 3 (SPC700's)
    SEP #$20                            ;Make A (8 bit)
    ...
    STA.w PPURegisters.APUPort1Reg2141  ;/ End the block transfer
    ADC #$7F                            ;Set the overflow flag if carry flag is set (Length is over 0000)
    PLA                                 ;\ Take out A
    STA.w PPURegisters.APUPort0Reg2140  ;| Store it into APU I/O port 0. Wait until they are equal (SPC700 has caught up)
.WaitSPC700
    CMP.w PPURegisters.APUPort0Reg2140  ;|
    BNE .WaitSPC700                     ;/
...
.WaitSPC700 
    CMP.w PPURegisters.APUPort0Reg2140  ;\ Wait for HW_APUIO0 to equal the counter (SPC700 has caught up)
    BNE .WaitSPC700                     ;/
...
StoreByte:
    ...
    BNE GetNextByte                     ;/
.WaitSPC700  
    CMP.w PPURegisters.APUPort0Reg2140  ;Then make sure that APU I/O port 0 is the same as X
    BNE .WaitSPC700                     ;
.WaitSPC700_2
...
Finished:
    ...
    STA.w PPURegisters.APUPort2Reg2142
    LDA.b DirectPage.Scratch+5
    INC
    AND #$00FF
    STA.w PPURegisters.APUPort0Reg2140
    SEP #$30
.WaitSPC700  
    CMP.w PPURegisters.APUPort0Reg2140
